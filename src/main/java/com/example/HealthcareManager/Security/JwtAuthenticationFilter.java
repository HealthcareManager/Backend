...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(@NonNull HttpServletRequest request, @NonNull HttpServletResponse response,
        ...
        if (requestURI.equals("/HealthcareManager/api/auth/login") || requestURI.equals("/HealthcareManager/api/auth/register") || requestURI.equals("/HealthcareManager/api/auth/google-login") || requestURI.equals("/HealthcareManager/api/auth/facebook-login") || requestURI.equals("/HealthcareManager/api/auth/line-callback")) {
