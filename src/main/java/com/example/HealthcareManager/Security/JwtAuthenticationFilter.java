...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(@NonNull HttpServletRequest request, @NonNull HttpServletResponse response,
        ...
        if (requestURI.equals("/api/auth/login") || requestURI.equals("/api/auth/register") || requestURI.equals("/api/auth/google-login") || requestURI.equals("/api/auth/facebook-login") || requestURI.equals("/api/auth/line-callback")|| requestURI.equals("/api/payment")|| requestURI.equals("/api/save")|| requestURI.equals("/api/details/{orderId}")|| requestURI.equals("/api/healthData")|| requestURI.equals("/api/admin/admin-login")) {
